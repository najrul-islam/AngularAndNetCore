...
namespace Utility.StaticData
{
    public static class StaticData
    {
        ...
        public const string MIGRATION_ASSEMBLY = "STSCapitalApi";
        ...
        public const string TASK_DELETE_SUCCESS = "Task deleted successfully";
        public const string TASK_UPDATE_SUCCESS = "Task updated successfully";
