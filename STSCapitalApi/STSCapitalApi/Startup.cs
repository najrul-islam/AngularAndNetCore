...
namespace STSCapitalApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.RegisterSTSCapitalServiceInstance(Configuration);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                scope.ServiceProvider.GetService<STSCapitalContext>().Database.Migrate();
           ...
           // HTTPS Redirection Middleware to redirect HTTP requests to HTTPS.
            ...
            app.Run(async context =>
            {
                if (context.Request.Path.Value == "/")
                {
                    ...
                    await context.Response.WriteAsync($"{{status :'STSCapital API is Running.'}} Version: {ver}. Environment: {env.EnvironmentName}");
                }
                else
                {
